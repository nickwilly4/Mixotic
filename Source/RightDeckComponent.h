...
class RightDeckComponent  : public juce::Component//,public juce::ChangeListener,public juce::Timer
{
public:
    //==============================================================================
    RightDeckComponent();
    ~RightDeckComponent() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RightDeckComponent)
